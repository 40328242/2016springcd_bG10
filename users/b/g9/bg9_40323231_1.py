...
bg9_40323231_1 = Blueprint('bg9_40323231_1', __name__, url_prefix='/bg9_40323231_1', template_folder='templates')
...
@bg9_40323231_1.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323231_1.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg9_40323231_1.route('/circle36/<x>/<y>/<degree>')
#@bg9_40323231_1.route('/circle36/<int:x>/<int:y>/<int:degree>')
