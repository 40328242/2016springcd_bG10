...
bg9_40323233_1 = Blueprint('bg9_40323233_1', __name__, url_prefix='/bg9_40323233_1', template_folder='templates')
...
'''
    ...
    return outstring
@bg9_40323233_1.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg9_40323233_1.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323233_1.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg9_40323233_1.route('/circle1/<x>/<y>/<degree>')
#@bg9_40323233_1.route('/circle1/<int:x>/<int:y>/<int:degree>')
...
@bg9_40323233_1.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323233_1.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg9_40323233_1.route('/circle2/<x>/<y>/<degree>')
#@bg9_40323233_1.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg9_40323233_1.route('/twocircle/<x>/<y>')
@bg9_40323233_1.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg9_40323233_1.route('/eighteenthirty/<x>/<y>')
@bg9_40323233_1.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg9_40323233_1.route('/snap')
...
@bg9_40323233_1.route('/snap_link')
...
@bg9_40323233_1.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
...
def O(x, y, rx, ry, rot, color, border, linewidth):
    ...
    chamber = "M12.550 19.023 A16.780,16.780 0 0,0 16.598,40.807 A16.780,16.780 0 0,0 38.721,39.587 A16.780,16.780 0 0,0 40.349,17.490 L37.274,5.000 L36.191,13.596 A16.780,16.780 0 0,0 17.601,13.688 L14.206,5.643 L12.550,19.023 M20.565 28.427 A5.415,5.415 0 0,1 15.151,23.012 A5.415,5.415 0 0,1 20.565,17.598 A5.415,5.415 0 0,1 25.980,23.012 A5.415,5.415 0 0,1 20.565,28.427 M34.165 28.591 A5.579,5.579 0 0,1 28.587,23.012 A5.579,5.579 0 0,1 34.165,17.434 A5.579,5.579 0 0,1 39.744,23.012 A5.579,5.579 0 0,1 34.165,28.591 M30.565 41.412 L23.565,41.412 L23.565,33.612 L30.565,33.612 L30.565,41.412 z"
    cgoChamber = window.svgToCgoSVG(chamber)
