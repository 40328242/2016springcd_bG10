...
bg9_40323218_1 = Blueprint('bg9_40323218_1', __name__, url_prefix='/bg9_40323218_1', template_folder='templates')
...
@bg9_40323218_1.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323218_1.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg9_40323218_1.route('/circle36/<x>/<y>/<degree>')
#@bg9_40323218_1.route('/circle36/<int:x>/<int:y>/<int:degree>')
def drawcircle36(x,y,degree):
    return head_str + chain_str + circle36(int(x), int(y), int(degree)) + tail_str
    
    
@bg9_40323218_1.route('/bike')
def bike():
    outstring = '''
<!DOCTYPE html>
<html>
...
@bg9_40323218_1.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg9_40323218_1.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323218_1.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg9_40323218_1.route('/circle1/<x>/<y>/<degree>')
#@bg9_40323218_1.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@bg9_40323218_1.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323218_1.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg9_40323218_1.route('/circle2/<x>/<y>/<degree>')
#@bg9_40323218_1.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg9_40323218_1.route('/twocircle/<x>/<y>')
@bg9_40323218_1.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg9_40323218_1.route('/eighteenthirty/<x>/<y>')
@bg9_40323218_1.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg9_40323218_1.route('/snap')
...
@bg9_40323218_1.route('/snap_link')
...
@bg9_40323218_1.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
